...
ph= tkinter.PhotoImage(file='2.gif')
T = tkinter.Label(window, image=ph)
...
def showImg(img1):
    ...
    canvas1 = tkinter.Canvas(top1, width = image.width ,height = image.height)
